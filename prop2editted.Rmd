...
Round Bald is located in the Roan Mountain Massif of the Unaka Mountain range of the Southern Appalachian Mountains, between Carver's gap and Engine gap. The Appalachian Trail (AT) bisects the study site into North of the trail and South of the trail into Tennessee and North Carolina, respectively. The site itself is spread across Pisgah National Forest in North Carolina and Cherokee National Forest in Tennessee, at approximately 36° 06'N and 82° 60'W. In this study I sampled transects reestablished by @stok2022 after a 30-year mowing management protocol established by @hame1990 and @murd1986. I measured the percent coverage of vegetation using a 1-m^2^ PVC quadrat divided into 100 equal sized squares. Following @hame1990, each square was visually assigned by dominant vegetation type to equal 100% coverage per plot. Using the data collection guide designed to focus on vegetation types from @stok2022 and USFS botanist Gary Kauffman, was used to measure 226 plots. These plots lie along 12 transects that were sampled in 2020, of these, 52 plots along the first four transects were in the February 2022 fire and another 47 plots along the same transects were untouched by the fire. This provided an opportunity to examine the changes in plant community composition following low-intensity ground fire over two sampling seasons in 2022 and 2023.
...
Much of what we do this Summer, will be repeated from what was done in 2020 and 2022. However, we have added a second method to our soil seed bank analysis to provide a more detailed estimate of the seed bank. This should make it more comparable to the current vegetation structure and speculate on the future composition of Round Bald resulting, mainly, from mowing management on Round Bald. In 2022, soil emergence was utilized to gather data as close to the fire disturbance as possible. In the Spring of 2023, we plan to use the second set of seedbank samples to examine germination requirements of the main vegetation types - grass, sedge, and *Rubus*. These methods are modified soil extraction methods from @pric2010, @abel2013, and @chiq2018. These authors identify that both methods can provide insight into the vegetation community, but a combination of the two provides a more detailed estimate of the seed bank. I intend to measure soil moisture, ambient temperature and humidity, then compare these values to manipulated samples. I plan to manipulate the trays based on elevation, light availability, differences in watering, and whether acidic or basic water increases germination of selected vegetation. 
